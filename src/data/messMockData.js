// Dashboard Stats - Using icon names as strings instead of JSX components
export const dashboardStats = [
  {
    ...
    icon: 'users' // String identifier instead of JSX
  },
  {
    title: 'Meals Booked',
...
export const mealPlans = [
  ...
  },
  {
    ...
    duration: 'Monthly',
    mealsPerDay: 3,
    features: ['All Basic Features', 'Special Menu on Sundays', 'Guest Meal Vouchers (2/month)'],
    isActive: true,
    subscribers: 428
  },
  {
...
export const recentTransactions = [
  { id: 'TRX001', user: 'Rahul Kumar (B2021001)', plan: 'Basic Mess Plan', amount: 3500, date: '2024-01-15', status: 'completed' },
  { id: 'TRX002', user: 'Priya Singh (B2021002)', plan: 'Premium Mess Plan', amount: 4500, date: '2024-01-15', status: 'completed' },
  { id: 'TRX003', user: 'Dr. Suresh Sharma', plan: 'Staff Plan', amount: 4000, date: '2024-01-14', status: 'completed' },
  { id: 'TRX004', user: 'Amit Patel (B2021003)', plan: 'Basic Mess Plan', amount: 3500, date: '2024-01-14', status: 'pending' }
]
...
export const announcements = [
  {
    ...
    message: 'Enjoy a special menu on 26th January featuring traditional Indian dishes.',
    date: '2024-01-15',
...
export const staffList = [
  { id: 'STF001', name: 'Rajesh Mishra', role: 'Mess Manager', email: 'rajesh@iiitl.ac.in', access: 'full', status: 'active' },
  { id: 'STF002', name: 'Sunil Kumar', role: 'Kitchen Supervisor', email: 'sunil@iiitl.ac.in', access: 'kitchen', status: 'active' },
  { id: 'STF003', name: 'Meera Singh', role: 'Accounts', email: 'meera@iiitl.ac.in', access: 'finance', status: 'active' },
  { id: 'STF004', name: 'Amit Verma', role: 'Inventory Manager', email: 'amit@iiitl.ac.in', access: 'inventory', status: 'inactive' }
]
